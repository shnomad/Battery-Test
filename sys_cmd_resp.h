...
public:
    ...
    enum comm_cmd {
                     ...
                     CMD_COMM_GET_TIME, CMD_COMM_GET_STORED_VALUE_COUNT, CMD_COMM_DOWNLOAD, CMD_COMM_MEM_DELETE, CMD_COMM_UNKNOWN=0x1f
                 };Q_ENUM(comm_cmd)
    enum comm_resp {
                     ...
                     RESP_COMM_MEM_DELETE_FAIL, RESP_COMM_BGMS_RESP_FAIL,RESP_COMM_UNKNOWN=0x4f
                 };
